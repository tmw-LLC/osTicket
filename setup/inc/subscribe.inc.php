...
?>
    <div id="main">
        ...
        <p><?php echo __('SurePay Ticket installation has been completed successfully.');?></p>
        <h3 style="color:#FF7700;"><?php echo __('Stay up to date');?>: </h3>
        <?php echo __("It's important to keep your SurePay Ticket installation up to date. Get announcements, security updates and alerts delivered directly to you!");?>
        <br><br>
    ...
    <div id="sidebar">
            ...
            <p>
               <?php echo __('Launching a new customer support platform can be a daunting task. Let us get you started! We provide professional support services to help get osTicket up and running smoothly for your organization.');?> <a target="_blank" href="https://surepayltd.com/"><?php echo __('Learn More!');?></a>
            </p>
    </div>
